      ...
      <>
        ...
        <div className=" about-bg flex items-center mb-4">
          <div className="container  ">
            ...
            <p className="w-1/2 pt-0 ms-10">
              <span className="font-bold">salalah</span> is a e-commerce company
              that sells great products based on a design-driven value, with
        ...
        <div className="container shadow-sm rounded-md border    p-10 bg-white">
          <div className="flex  justify-between container p-10 my-10-3">
            <div className="p-3  border-e-4 w-75 ">
              ...
              <p className="w-75 ">
                Sells great products for users Create a joyful and progressive
                environment for employees Create win-win platforms for partners
                based on mutual trust Render steady long term returns on
            ...
            <div className="p-3 md:px-5 ">
              ...
              <div className>
                ...
                <p className="">
                  Trusted,Benfen, user-orientation, continuous learning and team
                  spirit
                </p>
              </div>
            </div>
